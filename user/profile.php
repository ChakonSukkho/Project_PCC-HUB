...
<body>
        ...
        <main class="main-content">
            ...
            <section class="welcome-section">
                <div class="welcome-content">
                    <!-- Profile Image View Mode (Always visible, non-clickable) -->
                    <div class="profile-display-container" id="profileDisplayContainer">
                        <div class="profile-image-display"  style="width:200px; height:200px; border-radius:50%; overflow:hidden; display:flex; align-items:center; justify-content:center; background:#f3f4f6; box-shadow:0 5px 20px rgba(0,0,0,0.1); margin:0 auto 15px auto;">
                            <?php if (!empty($profile_image) && file_exists('../uploads/profiles/' . $profile_image)): ?>
                                <img src="../uploads/profiles/<?php echo htmlspecialchars($profile_image); ?>" alt="Profile" id="displayImage">
                            <?php else: ?>
                                <div class="profile-image-placeholder-display">👤</div>
                            <?php endif; ?>
                        </div>
                    </div>
            
                    <!-- Profile Image Edit Mode (Hidden by default, only shown when editing) -->
                    <div class="image-upload-container" id="imageUploadContainer" style="display: none;">
                        ...
                        <div class="image-info">Click to change profile picture</div>
                    </div>
                    
                    <div class="welcome-text">
                        <h1>Hi, <?php echo htmlspecialchars($user['user_name']); ?>! <span class="wave-emoji">👋</span></h1>
    ...
    <script>
        ...
        // Updated JavaScript to handle show/hide for profile image
...
editProfileBtn.addEventListener('click', function() {
    ...
    // Hide display mode and show edit mode for profile image
...
cancelBtn.addEventListener('click', function() {
    ...
    // Show display mode and hide edit mode for profile image
...
// Image preview function (only works in edit mode)
function previewImage(input) {
    if (input.files && input.files[0]) {
        const reader = new FileReader();
        reader.onload = function(e) {
